...
const en: AppDict = {
  ...
  kb: {
    ...
    fileHint: "PDF, Word, image, TXT or MD — up to 4 MB.", addBtn: "Add to knowledge", processing: "Processing…",
...
const ru: AppDict = {
  ...
  kb: {
    ...
    fileHint: "PDF, Word, изображение, TXT или MD — до 4 МБ.", addBtn: "Добавить в знания", processing: "Обрабатываем…",
...
const fr: AppDict = {
  ...
  kb: {
    ...
    fileHint: "PDF, Word, image, TXT ou MD — jusqu'à 4 Mo.", addBtn: "Ajouter aux connaissances", processing: "Traitement…",
...
const es: AppDict = {
  ...
  kb: {
    ...
    fileHint: "PDF, Word, imagen, TXT o MD — hasta 4 MB.", addBtn: "Añadir al conocimiento", processing: "Procesando…",
...
const de: AppDict = {
  ...
  kb: {
    ...
    fileHint: "PDF, Word, Bild, TXT oder MD — bis 4 MB.", addBtn: "Zum Wissen hinzufügen", processing: "Wird verarbeitet…",
